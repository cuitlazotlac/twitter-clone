...
import { Row, Form, Button, Card, ListGroup, Image } from "react-bootstrap";
import { create as ipfsHttpClient } from "ipfs-http-client";

import missing_nft from "./assets/missing_nft.png";
    ...
    <div className="container-fluid mt-5">
      {hasProfile ? (
        ...
        <div className="text-center">
          <main style={{ padding: "1rem 0" }}>
            <div>
              <Image className="image_focus" src={missing_nft} />
            </div>
            <h3>You must own an NFT to post</h3>
            <h4>Check you profile page to create one</h4>
          </main>
        </div>
      )}
