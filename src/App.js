...
import missing_wallet from "./assets/missing_wallet.png";
...
function App() {
  ...
  return (
    <BrowserRouter>
      <div className="App">
        <>
          <Navbar expand="lg" bg="dark" variant="dark" className="main-title">
            <Container>
              <Navbar.Brand href="">
                <img src={logo} width="40" height="40" alt="" />
                <h6 className="title">Spread</h6>
              </Navbar.Brand>
        ...
        <div>
          {loading ? (
            ...
            >
              ...
              <div>
                <Image className="image_focus" src={missing_wallet} />
              </div>
              <p className="mx-3 my-0">
                You need to connect a wallet to use this application
              </p>
              <div>
                <br />
